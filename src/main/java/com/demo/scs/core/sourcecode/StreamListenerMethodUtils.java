...
public class StreamListenerMethodUtils {
    ...
    public static void validateStreamListenerMethod(Method method, int inputAnnotationCount, int outputAnnotationCount,
        ...
        if (isDeclarative) {
            Assert.isTrue(!StringUtils.hasText(condition), StreamListenerErrorMessages.CONDITION_ON_DECLARATIVE_METHOD);
