 ...
 * @since 1.2
 */
public class StreamListenerMessageHandlerExt extends AbstractReplyProducingMessageHandler {

    private final InvocableHandlerMethod invocableHandlerMethod;

    private final boolean copyHeaders;

    public StreamListenerMessageHandlerExt(InvocableHandlerMethod invocableHandlerMethod, boolean copyHeaders,
